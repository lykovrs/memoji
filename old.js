function memoji(options) {
    var rootElement = options.rootElement,
        timerElement = options.timerElement,
        classCard = options.classCard,
        openCardClass = options.openCardClass,
        timeRound = options.timeRound,
        roundSuccessClass = options.roundSuccessClass,
        roundErrorClass = options.roundErrorClass;
    ...
    rootElement.addEventListener("click", function(ev) {
        ...
        if ("card" in control.dataset) {
            ...
            if (currentIcon !== prevIcon) {
                control.classList.add(roundErrorClass);
                prevControl.classList.add(roundErrorClass);
            ...
            if (currentIcon === prevIcon) {
                cardOpen(control, openCardClass);
                control.classList.add(roundSuccessClass);
                control.dataset.ready = true;
                prevControl.classList.add(roundSuccessClass);
